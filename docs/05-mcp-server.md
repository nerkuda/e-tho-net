...
ошибка валидации любого ключа откатывает весь набор. Для `thought_ref`-свойств
с `config.multiple` значение может быть массивом id: пустой массив очищает
значение, одиночный id нормализуется в массив из одного; без флага `multiple`
массив отвергается (422). Ответ одиночной формы —
