...
| L — Пост-MVP доработки | ⏳ `in_progress` | L1–L19: вложения, Ctrl-лупа, FLIP-анимации, удаление мысли, меню связей, типы, вкладки редактора, сплиттеры/зум холста, тёмная тема, облачко, эллипсы/авто-контраст, SVG-хром, кривые Безье, структуры мыслей, иконки из картинки, диалог иконки, закреплённые мысли, упрощение добавления мыслей | [phase-l.md](workplan/phase-l.md) |
