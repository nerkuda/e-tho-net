...
| L — Пост-MVP доработки | ⏳ `in_progress` | L1–L20: вложения, Ctrl-лупа, FLIP-анимации, удаление мысли, меню связей, типы, вкладки редактора, сплиттеры/зум холста, тёмная тема, облачко, эллипсы/авто-контраст, SVG-хром, кривые Безье, структуры мыслей, иконки из картинки, диалог иконки, закреплённые мысли, упрощение добавления мыслей, хроника (третий рабочий стол) | [phase-l.md](workplan/phase-l.md) |
