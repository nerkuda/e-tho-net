...
| N — MCP: доработки | ✅ `done` | N1: инструмент `etn.thoughts.query`; N2: обогащённое чтение мысли (счётчики, превью постоянного комментария); N3: «Использование» мысли (счётчик + список с группировкой) | [phase-n.md](workplan/phase-n.md) |
